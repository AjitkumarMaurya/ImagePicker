package com.ajitmaurya.imagepicker.InsGallery;
...
import com.ajitmaurya.imagepicker.InsGallery.listener.OnItemLongClickListener;
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (index != RecyclerView.NO_POSITION && list.size() > index) {
                    ...
                    mOnAddPicClickListener.onDeletePicClick();
                }
            });
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                ...
                viewHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                        (R.drawable.ic_baseline_audiotrack_24, 0, 0, 0);
            ...
            if (chooseModel == PictureMimeType.ofAudio()) {
                viewHolder.mImg.setImageResource(R.drawable.ic_baseline_audiotrack_24);
            } else {
