...
import com.ajitmaurya.imagepicker.PictureSelectionModel;
    ...
    public static PictureSelectionModel applyInstagramOptions(Context context, InstagramSelectionConfig instagramConfig, PictureSelectionModel selectionModel) {
        ...
        if (CAMERA && VIDEO){
            return selectionModel
                    ...
                    .maxSelectNum(SELECT_COUNT)// 最大图片选择数量
                    .minSelectNum(1)// 最小选择数量
                    .maxVideoSelectNum(SELECT_COUNT) // 视频最大选择数量，如果没有单独设置的需求则可以不设置，同用maxSelectNum字段
