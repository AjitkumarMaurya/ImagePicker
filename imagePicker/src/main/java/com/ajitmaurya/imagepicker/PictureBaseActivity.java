...
import com.ajitmaurya.imagepicker.app.PictureAppMaster;
import com.ajitmaurya.imagepicker.compress.Luban;
import com.ajitmaurya.imagepicker.compress.OnCompressListener;
...
import com.ajitmaurya.imagepicker.dialog.PictureLoadingDialog;
import com.ajitmaurya.imagepicker.engine.ImageEngine;
import com.ajitmaurya.imagepicker.engine.PictureSelectorEngine;
import com.ajitmaurya.imagepicker.entity.LocalMedia;
import com.ajitmaurya.imagepicker.entity.LocalMediaFolder;
import com.ajitmaurya.imagepicker.immersive.ImmersiveManage;
import com.ajitmaurya.imagepicker.immersive.NavBarUtils;
import com.ajitmaurya.imagepicker.language.PictureLanguageUtils;
import com.ajitmaurya.imagepicker.listener.OnResultCallbackListener;
...
import com.ajitmaurya.imagepicker.tools.AndroidQTransformUtils;
...
import com.ajitmaurya.imagepicker.tools.VoiceUtils;
    ...
    private void initConfig() {
        ...
        if (config.style != null) {
            ...
            if (config.titleBarBackgroundColor != 0) {
                ...
                colorPrimary = AttrsUtils.getTypeValueColor(this, android.R.color.darker_gray);
            }

            if (config.pictureStatusBarColor != 0) {
                colorPrimaryDark = config.pictureStatusBarColor;
            } else {
                colorPrimaryDark = AttrsUtils.getTypeValueColor(this, android.R.color.darker_gray);
            }
        }
